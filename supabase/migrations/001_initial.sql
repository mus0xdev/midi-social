...
alter table public.profiles enable row level security; alter table public.midi_files enable row level security; alter table public.likes enable row level security; alter table public.comments enable row level security;
